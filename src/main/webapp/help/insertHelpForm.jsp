									...
									<div class="card ">
										...
										<div class="card-body ">
											<div class="form-group has-label">
												<label> 작성자 <star class="star">*</star>
												</label> <input type="text" name="memberId" value=<%=loginMemberId%>
													readonly="readonly" class="form-control">
											</div>
											<div class="form-group has-label">
												<label> 문의내용 <star class="star">*</star>
												</label>
												<textarea  id="helpMemo" placeholder="문의사항을 입력하세요..."
													class="form-control form-control-alternative" name="helpMemo"></textarea>
											</div>
											<!-- <div class="form-group has-label">
												<label> Confirm Password <star class="star">*</star>
												</label> <input class="form-control" name="password_confirmation"
										...
										<div class="card-footer text-right">
											<button type="button"
												class="btn btn-info btn-fill pull-right" id="insetHelpBt">문의하기</button>
