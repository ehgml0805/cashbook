					...
					<div class="card-body table-full-width table-responsive">
						<table class="table table-hover">
							<tr style="text-align: center;">
								...
								<td style="font-weight: bolder;" >작성 날짜</td>
								<td style="font-weight: bolder;" >답변 내용</td>
								<td style="font-weight: bolder;" >답변 날짜</td>
							...
							<tr style="text-align: center;">
								...
								<td>
									...
									<%
										if (m.get("commentMemo") == null) {
									%> 
										<a href="<%=request.getContextPath()%>/help/deleteHelpAction.jsp?helpNo=<%=m.get("helpNo")%>" style="color: red;">
