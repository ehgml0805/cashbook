		...
		<div class="container">
			<div class="p-5 mb-7 bg-light">
				...
				<form id="updateHelpForm"
					...
					method="post">
					<div>
						문의 번호 <input type="text" name="helpNo" value="<%=helpNo%>"
							readonly="readonly" class="form-control form-control">
					</div>
					<div>
						내용
						<textarea id="helpMemo"
							class="form-control  form-control-alternative" rows="10"
							cols="30" name="helpMemo"><%=helpMemo%></textarea>
					</div>
					<div>
