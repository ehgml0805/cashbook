					...
					<div class="container-fluid">
						<div class="row">
							<div class="col-md-6 mr-auto ml-auto">
								<form id="deleteForm" action="<%=request.getContextPath()%>/deleteMemberAction.jsp" method="post">
									<div class="card ">
										...
										<div class="card-body ">
											...
											<div class="form-group has-label">
												<label> 비밀번호<star class="star">*</star></label> 
										...
										<div class="card-footer text-right">
											<button type="button"
												class="btn btn-info btn-fill pull-right" id="deleteBt">탈퇴하기</button>
