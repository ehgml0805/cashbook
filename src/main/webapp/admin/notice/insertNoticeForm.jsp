					...
					<div class="container-fluid">
						<div class="row">
							<div class="col-md-6 mr-auto ml-auto">
								<form id="insertNoticeForm" action="<%=request.getContextPath()%>/admin/notice/insertNoticeAction.jsp" method="post">
									<div class="card ">
										...
										<div class="card-body ">
											<div class="form-group has-label">
												...
												<textarea  placeholder="공지사항을 입력하세요." id="noticeMemo"
													class="form-control form-control-alternative" name="noticeMemo"></textarea>
											</div>
										...
										<div class="card-footer text-right">
											<button type="button" class="btn btn-info btn-fill pull-right" id="insetNoticeBt">공지추가</button>
