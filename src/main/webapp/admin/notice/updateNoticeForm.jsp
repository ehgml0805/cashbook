...
<body style="overflow: auto;">
	<div class="wrapper">
		<div class="sidebar"
			data-image="../../resource2/assets/img/sidebar-4.jpg" data-color="orange">
			<!--
					...
					<div class="container-fluid">
						<div class="row">
							<div class="col-md-6 mr-auto ml-auto">
								<form id="updateNoticeForm" action="<%=request.getContextPath()%>/admin/notice/updateNoticeAction.jsp" method="post">
									<div class="card ">
										<div class="card-header ">
											<h4 class="card-title">공지사항 추가</h4>
										</div>
										<%
										if (msg1 != null) {
										%>
										...
										<div class="card-body ">
											<div class="form-group has-label">
												<label> 공지 번호 </label> 
												<input type="text" name="noticeNo" value=<%=noticeNo%> readonly="readonly" class="form-control">
											</div>
											<div class="form-group has-label">
												<label> 공지내용 <star class="star">*</star></label> 
												<textarea  id="noticeMemo" class="form-control form-control-alternative" name="noticeMemo"><%=notice.getNoticeMemo()%></textarea>
											</div>
										...
										<div class="card-footer text-right">
											<button type="button" class="btn btn-info btn-fill pull-right" id="updateNoticeBt">수정하기</button>
