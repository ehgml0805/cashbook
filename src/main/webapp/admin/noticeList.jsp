...
<body style="overflow: auto;">
	<div class="wrapper">
		...
		<div class="main-panel">
            ...
            <!-- End Navbar -->	
			<div class="col-md-12">
				<div class="card card-plain table-plain-bg" style="height: 730px;">
					<div class="card-header ">
						<h4 class="card-title">Notice List</h4>
						<p class="card-category">회원이 문의한 글을 쓴 내역을 볼 수 있음</p>
						<br>
						<a href="<%=request.getContextPath()%>/admin/notice/insertNoticeForm.jsp"
							style="font-weight: bold;">공지 글쓰기 </a>
					</div>
					<div class="card-body table-full-width table-responsive">
						...
						<tr style="text-align: center;">
							...
							<td>
								<a href="<%=request.getContextPath()%>/admin/notice/updateNoticeForm.jsp?noticeNo=<%=n.getNoticeNo()%>&noticeMemo=<%=n.getNoticeMemo()%>">
								<i class="fa fa-edit"></i> / </a>
								<a href="<%=request.getContextPath()%>/admin/notice/deleteNoticeAction.jsp?noticeNo=<%=n.getNoticeNo()%>" style="color: red;">
					...
					<div class="container" style="text-align: center;">
						<a href="<%=request.getContextPath()%>/admin/noticeList.jsp?currentPage=1" style="color: black;">처음</a>
						<%
						if (currentPage > 1) {
						%>
							<a href="<%=request.getContextPath()%>/admin/noticeList.jsp?currentPage=<%=currentPage - 1%>" style="color: black;">이전</a>
						<%
						}
						%>
						...
						%>
						<a href="<%=request.getContextPath()%>/admin/noticeList.jsp?currentPage=<%=currentPage + 1%>" style="color: black;">다음</a>
						<%
						}
						%>
						<a href="<%=request.getContextPath()%>/admin/noticeList.jsp?currentPage=<%=lastPage%>" style="color: black;">마지막</a>
					</div>
				</div>
			</div>
		</div>
