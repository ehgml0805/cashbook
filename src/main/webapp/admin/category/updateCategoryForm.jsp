		...
		<div class="main-panel">
					...
					<div class="collapse navbar-collapse justify-content-end"
						...
						<ul class="nav navbar-nav mr-auto">
							<li class="nav-item">
								...
								<i class="nc-icon nc-circle-09"></i> <span class="d-lg-none">Calender</span>
								</a>
							</li>
							<li class="dropdown nav-item">
								<a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
									<i class="nc-icon nc-planet"></i> <span class="notification">5</span>
					...
					<div class="container-fluid">
						<div class="row">
							<div class="col-md-6 mr-auto ml-auto">
								<form id="updateCategoryForm" action="<%=request.getContextPath()%>/admin/category/updateCategoryAction.jsp" method="post">
									<div class="card ">
										...
										<div class="card-body ">
											<div class="form-group has-label">
												<label> 수입 / 지출 <star class="star">*</star></label> 
												<div class="form-group">
													<%
													if (category.getCategoryKind().equals("수입")) {
													%>
															<input type="radio" name="categoryKind" id="categoryKind" value="수입" checked="checked">수입 &nbsp; 
															&nbsp;&nbsp;
															<input type="radio" id="categoryKind" name="categoryKind" value="지출">지출
													<%
													} else if (category.getCategoryKind().equals("지출")) {
													%>
															<input type="radio" name="categoryKind" id="categoryKind" value="수입">수입
															&nbsp;&nbsp;
															<input type="radio" name="categoryKind" id="categoryKind" value="지출" checked="checked">지출
													<%
													}
													%>
												</div>
												<div class="form-group has-label">
													<label>변경 전 항목 <star class="star">*</star></label> 
													<input type="text" name="categoryName" value="<%=category.getCategoryName()%>" class="form-control">
												</div>
												<div class="form-group has-label">
													<label>변경 후 항목 <star class="star">*</star></label> 
											...
											<div class="card-footer text-right">
												<button type="button" class="btn btn-info btn-fill pull-right" id="updateCategoryBt">수정하기</button>
			...
			<script>
					...
					updateCategoryBt.addEventListener('click', function(e) {
						...
						if($("input[name=categoryKind]:radio:checked").length < 1){
