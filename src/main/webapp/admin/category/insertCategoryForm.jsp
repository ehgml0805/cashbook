					...
					<div class="container-fluid">
						<div class="row">
							<div class="col-md-6 mr-auto ml-auto">
								<form id="insertcategoryForm" action="<%=request.getContextPath()%>/admin/category/insertCategoryAction.jsp" method="post">
									<div class="card ">
										...
										<div class="card-body ">
											...
											<div class="form-group has-label">
												<label> 항목 <star class="star">*</star></label> 
										...
										<div class="card-footer text-right">
											<button type="button" class="btn btn-info btn-fill pull-right" id="insertCategoryBt">추가하기</button>
