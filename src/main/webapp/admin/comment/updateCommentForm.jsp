					...
					<div class="container-fluid">
						<div class="row">
							<div class="col-md-6 mr-auto ml-auto">
								<form id="updateCommentForm" action="<%=request.getContextPath()%>/admin/comment/updateCommentAction.jsp" method="post">
									<div class="card ">
										...
										<div class="card-body ">
											...
											<div class="form-group has-label">
												<label> 답변 번호 </label> 
												<input type="text" name="commentNo" value=<%=commentNo%> readonly="readonly" class="form-control">
											</div>
											<div class="form-group has-label">
												<label> 답변 내용 <star class="star">*</star></label> 
												<textarea  placeholder="문의사항을 입력하세요..." id="commentMemo"
													class="form-control form-control-alternative" name="commentMemo"><%=comment.getCommentMemo() %></textarea>
											</div>
										...
										<div class="card-footer text-right">
											<button type="button" class="btn btn-info btn-fill pull-right" id="updateCommentBt">답변수정</button>
