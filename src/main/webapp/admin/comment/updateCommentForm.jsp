...
<body class="login-page">
		...
		<div class="container">
			<div class="p-5 mb-7 bg-light">
				...
				<form id="updateCommentForm"
					action="<%=request.getContextPath()%>/admin/comment/updateCommentAction.jsp" method="post">
					<div class="form-group">
					 <div style="font-weight: bold;">답변 번호</div>
						<input type="text" name="commentNo" value="<%=commentNo%>" readonly="readonly" class="form-control form-control-alternative"> 
					</div>
					<div style="font-weight: bold;">답변 내용</div>
					<div class="form-group">
						<textarea  class="form-control  form-control-alternative" rows="10" cols="30" name="commentMemo" id="commentMemo"><%=comment.getCommentMemo() %></textarea>
					</div>
					<div class="text-center">
						<button type="submit" class="btn btn-primary mt-4" id="updateCommentBt">답변 수정</button>
					</div>
				</form>
			</div>
		</div>
	...
	<script>
		let updateCommentBt=document.querySelector('#updateCommentBt');
		updateCommentBt.addEventListener('click', function(e) {
			console.log('updateCommentBt click');
